    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(theme) {
            case "winter":
                ...
                findViewById(R.id.round4Layout).setBackgroundResource(R.drawable.winterbackground);
                break;
            case "fall":
                changeTheme(R.drawable.leaf);
                findViewById(R.id.round4Layout).setBackgroundResource(R.drawable.fallbackground);
                break;
            case "spring":
                changeTheme(R.drawable.spring);
                findViewById(R.id.round4Layout).setBackgroundResource(R.drawable.springbackground);
                break;
            case "summer":
                changeTheme(R.drawable.summer);
                findViewById(R.id.round4Layout).setBackgroundResource(R.drawable.summerbackground);
                break;
        }
    }
...
//        iv6.setImageResource(imageResource);
    ...
    public void next(View v){
        ...
        Intent intent = new Intent(this,Round5.class);
