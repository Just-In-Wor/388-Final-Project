    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(theme) {
            case "winter":
                ...
                findViewById(R.id.round4Layout).setBackgroundColor(Color.GREEN);
                break;
            case "fall":
                changeTheme(R.drawable.leaf);
                findViewById(R.id.round4Layout).setBackgroundColor(Color.parseColor("#ffa500"));
                break;
            case "spring":
                changeTheme(R.drawable.spring);
                findViewById(R.id.round4Layout).setBackgroundColor(Color.YELLOW);
                break;
            case "summer":
                changeTheme(R.drawable.summer);
                findViewById(R.id.round4Layout).setBackgroundColor(Color.BLUE);
                break;
        }
    }
